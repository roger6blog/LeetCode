...
class Solution(object):
    def compareVersion(self, version1, version2):
        ...
        ver1 = version1.split(".")
        ver2 = version2.split(".")
        V = min(len(ver1), len(ver2))
        v = 0
        while v < V:
            if int(ver1[v]) > int(ver2[v]):
                return 1
            elif int(ver1[v]) < int(ver2[v]):
                return -1
            v += 1
...
# version1 = "1.01"
# version2 = "1.001"
# assert 0 == Solution().compareVersion(version1, version2)
...
version1 = "0.1"
version2 = "1.1"
assert -1 == Solution().compareVersion(version1, version2)
